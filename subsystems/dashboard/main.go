...
func Init() {
	for {
		...
		statusLine += fmt.Sprintf("|h %d t %d s: %d c: %.2f", common.State.IndexOffset, common.State.MinOffset, common.State.Distance()/uint64(common.IndexSize), common.State.Capacity)
